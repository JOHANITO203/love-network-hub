    ...
    <div className="bento-card p-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <ToggleItem
            ...
            description="Alerte si numéro ou tag détecté"
      ...
      <div className="border-t border-white/10 pt-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-semibold text-rose-300">Zone de danger</h3>
        </div>
...
const ToggleItem = ({ label, description, checked, onChange }: ToggleItemProps) => {
  return (
    <motion.div whileHover={{ x: 4 }} className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/10">
      ...
      <button
        ...
        className={`
          ...
          ${checked ? 'bg-love-primary' : 'bg-white/20'}
        `}
      >
        <motion.div
          initial={false}
