...
export const saveUserAction = (profileId: string, action: SwipeAction): SwipeResult => {
  ...
  // Log for development
  console.log(`💫 Action recorded: ${action} for profile ${profileId}`);
  console.log('📈 Current stats:', {
    likes: stats.likedProfiles.length,
    skips: stats.skippedProfiles.length,
    superLikes: stats.superLikes.length,
  });
