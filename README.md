# 💕 МойDate - Современное Приложение для Знакомств

Современное приложение для знакомств, разработанное с использованием React, TypeScript и Supabase, интегрирующее ИИ для голосовых бесед и умный алгоритм подбора пар.
